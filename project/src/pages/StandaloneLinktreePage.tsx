...
const StandaloneLinktreePage: React.FC = () => {
        ...
        <div className="flex justify-center space-x-6 mb-8">
          {socialLinks.map((social, index) => (
            <a
              ...
              className="bg-slate-800 hover:bg-slate-700 p-3 rounded-full transition-all duration-300 hover:scale-110 border border-slate-700 hover:border-yellow-500/50 hover:shadow-lg hover:shadow-yellow-500/20"
            >
              {React.cloneElement(social.icon, { className: "h-5 w-5 text-yellow-400" })}
            </a>
          ))}
        </div>
...
export default StandaloneLinktreePage;
